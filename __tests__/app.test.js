...
const { mungeLocation, mungeWeather, mungeHiking, mungeYelp } = require('../utils');
const rawTrailsData = require('../data/trails');
const rawYelpData = require('../data/yelp');
...
describe('app routes', () => {
  describe('routes', () => {
    ...
    test('returns munged loaction data', async() => {
  ...
  test('returns munged weather', async() => {
    ...
    const result = mungeWeather(hardWeatherData);
    expect(result).toEqual(expectation);
  });
  ...
  test('returns munged trails', async() => {
    ...
    const result = mungeHiking(rawTrailsData);
    expect(result).toEqual(expectation);
  });
  ...
  test('returns munged yelp', async() => {
    ...
    const result = mungeYelp(rawYelpData);
    expect(result).toEqual(expectation);
  });
